 ...
 * @return 程序退出代码
 * 
 * 创建应用程序实例和图表窗口，配置柱状图数据，添加页眉和页脚，并显示窗口。
 */
int main(int argc, char **argv)
{
    ...
    // 添加页眉和页脚
    widget.addHeaderFooter("默认页眉 - 顶部", HeaderFooter::Header, Position::North);
    widget.addHeaderFooter("默认页脚 - 底部", HeaderFooter::Footer, Position::South);
