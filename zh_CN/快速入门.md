...
来源:[README.md#L25-L29](https://zread.ai/cheng25/KDChart/README.md#L25-L29), [INSTALL.txt#L2-L12](https://zread.ai/cheng25/KDChart/INSTALL.txt#L2-L12)
...
来源:[INSTALL.txt#L21-L79](https://zread.ai/cheng25/KDChart/INSTALL.txt#L21-L79)
...
来源:[main.cpp#L25-L105](https://zread.ai/cheng25/KDChart/examples/Bars/Simple/main.cpp#L25-L105), [main.cpp#L114-L122](https://zread.ai/cheng25/KDChart/examples/Bars/Simple/main.cpp#L114-L122)
...
```mermaid
graph TD
    A[QStandardItemModel] -->|数据源| B[KDChart::BarDiagram]
    B -->|添加到| C[KDChart::CoordinatePlane]
    C -->|部分| D[KDChart::Chart]
    D -->|控件在| E[QWidget/Application]
```
...
- **不同图表类型**：尝试其他图表类型，如`LineDiagram`、`PieDiagram`或`PolarDiagram`
- **自定义**：探索轴配置、图例、页眉/页脚和样式选项
- **示例**：查看`/examples`目录，了解特定功能的演示
- **文档**：参考API文档和程序员手册，获取详细信息

[<概述.md](概述.md) 				         		 [安装指南.md>](安装指南.md)

[<概述](https://zread.ai/cheng25/KDChart/1-overview) 				         			[安装指南>](https://zread.ai/cheng25/KDChart/3-installation-guide)