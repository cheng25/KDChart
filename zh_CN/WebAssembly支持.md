...
来源：[README-WASM.md](https://zread.ai/cheng25/KDChart/README-WASM.md)
...
来源：[README-WASM.md#L3-L5](https://zread.ai/cheng25/KDChart/README-WASM.md#L3-L5)
...
来源：[README-WASM.md#L7-L11](https://zread.ai/cheng25/KDChart/README-WASM.md#L7-L11)
...
来源：[README-WASM.md#L11-L12](https://zread.ai/cheng25/KDChart/README-WASM.md#L11-L12)
...
cmake \
  ...
  -DCMAKE_FIND_ROOT_PATH=~/Qt/5.15.1/wasm_32/ \
...
来源：[README-WASM.md#L13-L20](https://zread.ai/cheng25/KDChart/README-WASM.md#L13-L20)
...
```cmake
# 查找 KDChart 库
find_package(KDChart REQUIRED)
 
# 将你的应用与 KDChart 链接
target_link_libraries(YourApp PRIVATE KDChart::kdchart)
```
...
来源：[README-WASM.md#L22-L24](https://zread.ai/cheng25/KDChart/README-WASM.md#L22-L24), [CMakeLists.txt#L228-L232](https://zread.ai/cheng25/KDChart/CMakeLists.txt#L228-L232)
...
cmake -DCMAKE_TOOLCHAIN_FILE=/path/to/emscripten/cmake/Modules/Platform/Emscripten.cmake \
      -DCMAKE_PREFIX_PATH=/path/to/qt/wasm_32 \
      -DCMAKE_BUILD_TYPE=Release \
      ..
make
```
...
记得查看 [官方 KDChart WebAssembly 演示](https://demos.kdab.com/wasm/kdchart) 以获取灵感和参考实现细节，以便在开发你自己的 WebAssembly 应用时参考。



[<Python绑定.md](Python绑定.md)						  [API参考.md>](API参考.md)

[<Python 绑定](https://zread.ai/cheng25/KDChart/16-python-bindings)							[API 参考>](https://zread.ai/cheng25/KDChart/18-api-reference)
